...
#define VTYSH_INDEX_APP  0
#define VTYSH_INDEX_MAX (sizeof(vtysh_client)/sizeof(vtysh_client[0]))

/* vtysh local configuration file. */
#define VTYSH_DEFAULT_CONFIG "/etc/qnat/qnatcfg.conf"

void vtysh_init_vty (void);
void vtysh_init_cmd (void);
extern int vtysh_connect_all ();
...
int execute_command (const char *command, int argc, const char *arg1, const char *arg2, const char *arg3, const char *arg4);
